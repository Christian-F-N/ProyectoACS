 ...
 * 
 */
@WebServiceClient(name = "WebServices", targetNamespace = "http://Web/", wsdlLocation = "http://localhost:8081/Servicios_ACS/WebServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICES_QNAME = new QName("http://Web/", "WebServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Servicios_ACS/WebServices?wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://Web/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Web/", "WebServicesPort"), WebServices.class, features);
    }
